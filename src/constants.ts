const data = {
    ...
    SPARQL_ENDPOINT: "http://example.org/sparql_endpoint",
    CONSOLID_SATELLITE: "http://example.org/consolid_satellite",
    USER_WEBID: "http://example.org/user_webid",
    ACTIVE_PROJECT: "http://example.org/active_project",
    ...
    DEFAULT_FEEDURL: "https://raw.githubusercontent.com/AECOstore/RESOURCES/main/configurations/welcome.ttl",
    SELECTED_CONCEPTS: "http://example.org/selected_concepts",
    SELECTED_REFERENCES: "http://example.org/selected_references",
    DEFAULT_PASSWORD: "test123",
    DEFAULT_USERNAME: "architect-duplex@example.org",
    DEFAULT_IDP: "http://localhost:3000",
    SPARQL_STORE: "http://example.org/sparql_store",
    RDF_RESOURCES: "http://example.org/rdf_resources",
}
